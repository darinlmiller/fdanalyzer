  ...
  <body> 
    ...
    <div id="main" class="container">
      ...
      foreach ($players as $player) {
        ...
        $points_high=intval($player["points_high"]);
      ...
      ?>
        <div style="overflow: auto; border-top: 1px solid blue; background-color: #ecf0f1;">
          <span id="numPlayers" style="border:1px solid; color:#2c3e50; float: left;"></span>
          <span style="border:1px solid; color:#2c3e50; float: right;">Last Updated: <i><?php echo $time_in_text ?></i><span>
        </div>
      </div> <!-- players -->
    </div> <!-- main container -->

    <!-- Add content to the popup -->
    <div id="my_popup" style="background-color: white; padding: 25px; border:1px solid; border-radius: 10px;">
      <h3 style="text-align: center;">Calculating lineups...</h3>   
      <img src="ajax-loader.gif" style="display: block; margin-left: auto; margin-right: auto;">
      <br>
      <!-- <button class="btn btn-default my_popup_close" disabled style="margin-left: auto; margin-right: auto;">Close</button> -->
    </div>
